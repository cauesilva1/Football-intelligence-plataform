...
export const SPORT_REGISTRY: Record<Sport, SportConfig> = {
  SOCCER: {
    ...
    ui: {
      ...
      teamsSubtitle: "Clubs",
      tournamentsSubtitle: "Tournaments",
      directoryTitle: "Club Directory",
      entityLabel: "clubs",
  ...
  BASKETBALL: {
    ...
    ui: {
      ...
      teamsSubtitle: "Franchises",
      tournamentsSubtitle: "Leagues",
      directoryTitle: "Franchises & Colleges",
      entityLabel: "franchises / programs",
  ...
  AMERICAN_FOOTBALL: {
    ...
    ui: {
      ...
      teamsSubtitle: "Franchises",
      tournamentsSubtitle: "Leagues",
      directoryTitle: "Franchises & Programs",
      entityLabel: "franchises / programs",
