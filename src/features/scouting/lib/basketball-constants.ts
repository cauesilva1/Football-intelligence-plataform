...
export const MIN_ASSISTS_OPTIONS = [0, 2, 4, 6, 8, 10] as const;
export const MIN_THREE_PT_PCT_OPTIONS = [0, 30, 35, 38, 40, 45] as const;

export const BASKETBALL_SCOUTING_SEASONS = [202627, 202526] as const;
